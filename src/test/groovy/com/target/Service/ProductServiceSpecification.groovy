...
class ProductServiceSpecification extends GroovyTestCase {
    public static final int BIG_LEBOWSKY_ID = 13860428
    public static final int INVALID_ID = 52690549
    public static final Double ONE_THOUSAND = 1000.00
    ...
    void testGetMyRetailJSON() {
        String msg = shouldFail(ResourceNotFoundException) {
            productService.getMyRetailJSON(INVALID_ID)
        }
        assertEquals(ID_NOT_FOUND_MSG, msg)
    }
